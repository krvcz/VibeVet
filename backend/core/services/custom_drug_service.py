...
from core.models import CustomDrug, Species, MeasurementUnit
...
def create_custom_drug(data: Dict[str, Any], user: User) -> CustomDrug:
    """
    ...
    try:
        ...
        measurement_unit: MeasurementUnit = MeasurementUnit.objects.get(id=data['measurement_target'])
...
def delete_custom_drug(custom_drug: CustomDrug, user: User) -> None:
    """
